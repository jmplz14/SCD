...
class ProdCons1SC
{
 ...
 int                        // variables permanentes
   ...
   primera_libre_lectura,
   primera_libre_escritura,
   n;
 mutex
...
{
  primera_libre_lectura = 0;
  primera_libre_escritura = 0;
  n = 0;
}
// -----------------------------------------------------------------------------
...
int ProdCons1SC::leer(  )
{
   ...
   const int valor = buffer[primera_libre_lectura % num_celdas_total] ;
   n--;
   primera_libre_lectura++;
...
void ProdCons1SC::escribir( int valor )
{
   ...
   buffer[primera_libre_escritura % num_celdas_total] = valor ;
   n++ ;
   primera_libre_escritura++;
